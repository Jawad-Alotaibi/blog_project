...
<body>
    <header class="header-bar mb-3">
        ...
        <div class="container d-flex flex-column flex-md-row align-items-center p-3">
            ...
            <div class="flex-row my-3 my-md-0">
                ...
                <a href="/profile/{{Auth::user()->username}}" class="mr-2"><img title="My Profile" data-toggle="tooltip"
                        data-placement="bottom" style="width: 32px; height: 32px; border-radius: 16px"
                        src="{{auth()->user()->avatar}}" alt="User Avatar" /></a>
    ...
    <footer class="border-top text-center small text-muted py-3 bg-white mt-auto w-100">
        <p class="m-0">&copy; {{ date('Y') }} <a href="/" class="text-muted">Postify</a>. All rights reserved for Jawad
            Alotaibi.</p>
    </footer>
