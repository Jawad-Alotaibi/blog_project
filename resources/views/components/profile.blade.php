<x-layout :doctitle="$doctitle">
    ...
    <div class="container py-md-5 container--narrow">
        <h2>
            <img class="avatar-small" src="{{$sharedData['postAuthorAvatar']}}" />
            {{$sharedData['username']}}
            ...
            <a style="color: black" class="btn btn-sm" href="/profile/{{$sharedData['username']}}/manage-avatar">Manage
                Avatar <i class="fas fa-user-cog"></i></a>
            @endif
            @endauth
        </h2>
